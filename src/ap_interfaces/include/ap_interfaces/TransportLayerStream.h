...
namespace Spinnaker
{
	...
	*/
	...
	public:
		...
		/**
		 * Description: Displays number of packets missed by this stream. Successful resent packets are not counted as a missed packet.
		 * Visibility: Expert
		 */
		...
		/**
		 * Description: DEPRECATED; Replaced by StreamPacketResendEnable. Enables or disables the packet resend mechanism.
		 * Visibility: Invisible
		 */
		GenApi::IBoolean &GevPacketResendMode;

		/**
		 * Description: DEPRECATED; Replaced by StreamPacketResendMaxRequests. Maximum number of resend requests per image. Each resend request consists of a span of consecutive packet IDs.
		 * Visibility: Invisible
		 */
		GenApi::IInteger &GevMaximumNumberResendRequests;

		/**
		 * Description: DEPRECATED; Replaced by StreamPacketResendTimeout. Time in milliseconds to wait after the image trailer is received and before the image is completed by the driver.
		 * Visibility: Invisible
		 */
		GenApi::IInteger &GevPacketResendTimeout;

		/**
		 * Description: DEPRECATED; Replaced by StreamReceivedPacketCount. Displays number of packets received on this stream.
		 * Visibility: Invisible
		 */
		GenApi::IInteger &GevTotalPacketCount;

		/**
		 * Description: DEPRECATED; Replaced by StreamMissedPacketCount. Displays number of packets missed by this stream. Successful resent packets are not counted as a missed packet.
		 * Visibility: Invisible
		 */
		GenApi::IInteger &GevFailedPacketCount;

		/**
		 * Description: DEPRECATED; Replaced by StreamPacketResendReceivedPacketCount. Displays number of packets received after retransmit request on this stream.
		 * Visibility: Invisible
		 */
		GenApi::IInteger &GevResendPacketCount;

		/**
		 * Description: DEPRECATED; Replaced by StreamIncompleteFrameCount. Displays number of images with missing packet.
		 * Visibility: Invisible
		 */
		GenApi::IInteger &StreamFailedBufferCount;

		/**
		 * Description: DEPRECATED; Replaced by StreamPacketResendRequestedPacketCount. Displays number of packets requested to be retransmitted on this stream.
		 * Visibility: Invisible
		 */
