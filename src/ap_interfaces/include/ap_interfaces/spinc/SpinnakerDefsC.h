...
/**
 * DEPRECATED. Use spinMJPGOptionEx instead.
 * Options for saving MJPG videos. Used in saving MJPG videos
 * with a call to spinAVIRecorderOpenMJPG().
 */
typedef SPINNAKERC_STRUCT_DEPRECATED("spinMJPGOption is deprecated, use spinMJPGOptionEx instead.") _spinMJPGOption
{
...
/**
 * Options for saving MJPG videos. Used in saving MJPG videos
 * with a call to spinAVIRecorderOpenMJPGEx().
 */
typedef struct _spinMJPGOptionEx
{
    /** Frame rate of the stream */
    float frameRate;
...
/**
 * DEPRECATED. Use spinAVIOptionEx instead.
 * Options for saving uncompressed videos. Used in saving AVI videos
 * with a call to spinAVIRecorderOpenUncompressed().
 */
typedef SPINNAKERC_STRUCT_DEPRECATED("spinAVIOption is deprecated, use spinAVIOptionEx instead.") _spinAVIOption
{
    /** Frame rate of the stream */
    float frameRate;
...
/**
 * Options for saving uncompressed videos. Used in saving AVI videos
 * with a call to spinAVIRecorderOpenUncompressedEx().
 */
typedef struct _spinAVIOptionEx
{
    /** Frame rate of the stream */
    float frameRate;
