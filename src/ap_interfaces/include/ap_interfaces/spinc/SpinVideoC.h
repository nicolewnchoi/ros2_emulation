...
extern "C"
{
    ...
    /*
     * DEPRECATED. Use spinVideoOpenUncompressedEx instead.
    ...
    SPINNAKERC_API_DEPRECATED(
        "spinVideoOpenUncompressed is deprecated, use spinVideoOpenUncompressedEx instead.",
     ...
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
    SPINNAKERC_API spinVideoOpenUncompressedEx(spinVideo* phSpinVideo, const char* pName, spinAVIOptionEx option);

    /*
     * DEPRECATED. Use spinVideoOpenMJPGEx instead.
     ...
     */
    SPINNAKERC_API_DEPRECATED(
        "spinVideoOpenMJPG is deprecated, use spinVideoOpenMJPGEx instead.",
     ...
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
    SPINNAKERC_API spinVideoOpenMJPGEx(spinVideo* phSpinVideo, const char* pName, spinMJPGOptionEx option);
