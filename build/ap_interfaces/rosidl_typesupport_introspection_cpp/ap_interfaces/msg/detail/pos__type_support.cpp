...
{
  const auto & member =
    *reinterpret_cast<const std::array<int8_t, 18> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<int8_t, 18> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & member =
    *reinterpret_cast<const std::array<std::string, 18> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<std::string, 18> *>(untyped_member);
  return &member[index];
}
